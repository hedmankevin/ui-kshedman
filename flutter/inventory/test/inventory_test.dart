...
import 'package:inventory/main.dart';  // Make sure this import is correct
...
void main() {
  testWidgets('Rock Inventory UI Test', (WidgetTester tester) async {
    ...
    expect(find.text('Amethyst'), findsNothing);  // Ensure that only the matching items are shown
